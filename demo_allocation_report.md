...
> **Validation status (Standard §5, mandatory):** PRE-VALIDATION PROTOTYPE — methodology not yet validated against the Standard §7 ground-truth benchmark; error characteristics not yet published.
